...
const Publications = () => {
  ...
  const publications = [
    ...
    },
    {
      ...
      pdfUrl: "/pdfs/articles/deepseek-ai.pdf",
      category: "Articles",
      date: "2024-03-15"
    },
    // College News
    {
      ...
      pdfUrl: "/pdfs/collegenews/news_edition_12.pdf",
    ...
    },
    {
      ...
      pdfUrl: "/pdfs/collegenews/news_edition_11.pdf",
      category: "College News",
      date: "2024-04-01"
    },
    {
    ...
    },
    {
      ...
      pdfUrl: "/pdfs/collegenews/news_edition_9.pdf",
      category: "College News",
      date: "2024-01-20"
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      pdfUrl: "/pdfs/collegenews/news_edition_8.pdf",
      category: "College News",
    ...
    },
    {
      ...
      pdfUrl: "/pdfs/collegenews/news_edition_7.pdf",
      category: "College News",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      pdfUrl: "/pdfs/collegenews/news_edition_6.pdf",
      category: "College News",
    ...
    },
    {
      ...
      pdfUrl: "/pdfs/collegenews/news_edition_5.pdf",
      category: "College News",
    ...
    },
    {
      ...
      pdfUrl: "/pdfs/collegenews/news_edition_4.pdf",
      category: "College News",
    ...
    },
    {
      ...
      pdfUrl: "/pdfs/collegenews/news_edition_3.pdf",
      category: "College News",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1523580494863-6f3031224c94?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      pdfUrl: "/pdfs/collegenews/news_edition_2.pdf",
      category: "College News",
    ...
    },
    {
      ...
      pdfUrl: "/pdfs/collegenews/news_edition_1.pdf",
      category: "College News",
    ...
    // Annual Magazine
    {
      ...
      pdfUrl: "/pdfs/annualmagazine/Annual Magazine_2022-2023.pdf",
    ...
    },
    {
      ...
      pdfUrl: "/pdfs/annualmagazine/Annual Magazine_2023-2024.pdf",
      category: "Annual Magazine",
      date: "2024-01-30"
    },
  ];
